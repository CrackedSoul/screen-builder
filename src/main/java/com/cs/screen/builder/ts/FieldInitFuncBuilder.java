...
public class FieldInitFuncBuilder extends STGroupBuilder {

	public FieldInitFuncBuilder(STGroup stGroup) {
		super(stGroup);
	}
	public  String genFieldInitFunc(FieldItem field) {
		String rtn="";
	...
	private  String genSelectField(FieldItem field) {
		if (((SelectFieldItem) field).getOptionsName() != null) {
			ST st = getStGroup().getInstanceOf("varInitFunc");

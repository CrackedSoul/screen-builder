...
public class Test {
	public static void main(String args[]) throws FileNotFoundException {
		 String json=JsonUtils.readJson("E:\\Eclipse\\oxygen3\\ws\\Simple\\screen-builder\\src\\main\\resources\\accTD.json");
	     JsonObject jsonObject=new Gson().fromJson(json,JsonObject.class);
	     TrxComponent trxComp=JsonUtils.convertComp(jsonObject);	
